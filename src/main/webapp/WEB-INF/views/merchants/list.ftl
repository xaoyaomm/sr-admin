		...
		<tbody>
			<#list mercList as item>
			   <tr target="id"  rel="${item.user.id!}">
			      ...
			      <td><#if item.totalOrder gt 0><a  href="${request.contextPath}/merchants/orders/${item.user.id!}?type=1" height="700" width="1000" mask="true" target="dialog" title="接到订单" rel="merchants_orders">${item.totalOrder!}</a><#else>0</#if></td>
			      <td><#if item.totalTry gt 0><a  href="${request.contextPath}/merchants/orders/${item.user.id!}?type=3" height="700" width="1000" mask="true" target="dialog" title="尝试接单" rel="merchants_orders">${item.totalTry!}</a><#else>0</#if></td>
			      <td><#if item.totalSucc gt 0><a  href="${request.contextPath}/merchants/orders/${item.user.id!}?type=2" height="700" width="1000" mask="true" target="dialog" title="成功订单" rel="merchants_orders">${item.totalSucc!}</a><#else>0</#if></td>
			      <td><#if item.totalFail gt 0><a  href="${request.contextPath}/merchants/orders/${item.user.id!}?type=4" height="700" width="1000" mask="true" target="dialog" title="失败订单" rel="merchants_orders">${item.totalFail!}</a><#else>0</#if></td></a>
