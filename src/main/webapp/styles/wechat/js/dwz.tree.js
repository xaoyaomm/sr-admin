 ...
 (function($){
 	$.extend($.fn, {
		...
		_checkParent:function(){
			...
			var aClass = (ckboxed==ckbox?"checked":(ckboxed!=0?"checked":""));
			...
			var ckbox = $(">div>.ckbox",this);
			var cked = ckbox.hasClass("checked");
		    ckbox.find("input").attr("checked",cked);
			
			//if (aClass == "checked") {
				//$checkbox.attr("checked","checked");
				 //$(">div>.ckbox",this).find("input").attr("checked",'true');
			//} 
