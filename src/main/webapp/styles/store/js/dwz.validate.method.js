...
(function($){
	if ($.validator) {
		...
		$.validator.addMethod("phone", function(value, element) {
			return this.optional(element) || /^(\(\d{3,4}\)|\d{3,4}-)?\d{3,8}(-(\d{3,}))?$/.test(value);
		}, "Please specify a valid phone number");
		
		$.validator.addMethod("mobile", function(value, element) {
			return this.optional(element) || /^(0|86|17951)?(13[0-9]|15[012356789]|18[0123456789]|14[57])[0-9]{8}$/.test(value);
		...
		$.validator.addClassRules({
			...
			alphanumerics: { alphanumerics: true },
